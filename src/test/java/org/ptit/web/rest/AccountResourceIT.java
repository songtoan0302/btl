...
import org.ptit.repository.AuthorityRepository;
...
import org.ptit.service.dto.PasswordChangeDTO;
import org.ptit.web.rest.vm.KeyAndPasswordVM;
import org.ptit.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        Optional<User593> user = userRepository.findOneByEmailIgnoreCase("funky@example.com");
    ...
    void testRegisterInvalidEmail() throws Exception {
        ...
        Optional<User593> user = userRepository.findOneByLogin("bob");
        assertThat(user).isEmpty();
    }
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        Optional<User593> testUser = userRepository.findOneByEmailIgnoreCase("alice2@example.com");
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        Optional<User593> testUser1 = userRepository.findOneByLogin("test-register-duplicate-email");
        ...
        Optional<User593> testUser2 = userRepository.findOneByLogin("test-register-duplicate-email");
        assertThat(testUser2).isEmpty();

        Optional<User593> testUser3 = userRepository.findOneByLogin("test-register-duplicate-email-2");
        ...
        Optional<User593> testUser4 = userRepository.findOneByLogin("test-register-duplicate-email-3");
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        Optional<User593> userDup = userRepository.findOneWithAuthoritiesByLogin("badguy");
    ...
    void testSaveAccount() throws Exception {
        ...
        User593 updatedUser = userRepository.findOneWithAuthoritiesByLogin(user.getLogin()).orElse(null);
    ...
    void testSaveExistingEmail() throws Exception {
        ...
        User593 anotherUser = new User593();
        ...
        User593 updatedUser = userRepository.findOneByLogin("save-existing-email").orElse(null);
    ...
    void testSaveExistingEmailAndLogin() throws Exception {
        ...
        User593 updatedUser = userRepository.findOneByLogin("save-existing-email-and-login").orElse(null);
    ...
    void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        User593 updatedUser = userRepository.findOneByLogin("change-password-wrong-existing-password").orElse(null);
    ...
    void testChangePassword() throws Exception {
        ...
        User593 updatedUser = userRepository.findOneByLogin("change-password").orElse(null);
    ...
    void testChangePasswordTooSmall() throws Exception {
        ...
        User593 updatedUser = userRepository.findOneByLogin("change-password-too-small").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testChangePasswordTooLong() throws Exception {
        ...
        User593 updatedUser = userRepository.findOneByLogin("change-password-too-long").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testChangePasswordEmpty() throws Exception {
        ...
        User593 updatedUser = userRepository.findOneByLogin("change-password-empty").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testFinishPasswordReset() throws Exception {
        ...
        User593 updatedUser = userRepository.findOneByLogin(user.getLogin()).orElse(null);
