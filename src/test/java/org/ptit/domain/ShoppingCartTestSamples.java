...
public class ShoppingCartTestSamples {
    ...
    public static ShoppingCart getShoppingCartSample1() {
        return new ShoppingCart().id(1L).quantity(1).userId(1L);
    }

    public static ShoppingCart getShoppingCartSample2() {
        return new ShoppingCart().id(2L).quantity(2).userId(2L);
    }

    public static ShoppingCart getShoppingCartRandomSampleGenerator() {
        return new ShoppingCart().id(longCount.incrementAndGet()).quantity(intCount.incrementAndGet()).userId(longCount.incrementAndGet());
    }
}
