...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERPRODUCT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERPRODUCT actions', async () => {
      const expectedActions = [
        {
