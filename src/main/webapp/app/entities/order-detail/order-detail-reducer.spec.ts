...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERDETAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERDETAIL actions', async () => {
      const expectedActions = [
        {
